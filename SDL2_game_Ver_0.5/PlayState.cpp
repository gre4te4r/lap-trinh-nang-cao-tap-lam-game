...
bool PlayState::onEnter()
{
    ...
    if (!TextureManager::Instance()->load("background (1).png", "background", TheGame::Instance()->getRenderer()))
    {
        return false;
    }
...
bool PlayState::onExit()
{
    ...
    TextureManager::Instance()->clearFromTextureMap("run");
    TextureManager::Instance()->clearFromTextureMap("idle");
    TextureManager::Instance()->clearFromTextureMap("enemyRun");
