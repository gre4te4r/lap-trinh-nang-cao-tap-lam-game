...
bool Game::init(const char *title, int xpos, int ypos, int width, int height, int flags)
{
    ...
    if (!TheTextureManager::Instance()->load("menuBackground.png", "menuBackground", TheGame::Instance()->getRenderer()))
    {
        return false;
    }
    if (!TextureManager::Instance()->load("sPlayerRun_strip7.png", "run", TheGame::Instance()->getRenderer()))
    {
        return false;
    }

    if (!TextureManager::Instance()->load("sPlayerIdle_strip4.png", "idle", TheGame::Instance()->getRenderer()))
    {
        return false;
    }
    if (!TextureManager::Instance()->load("sEnemy_strip7.png", "enemyRun", TheGame::Instance()->getRenderer()))
    {
        return false;
    }

    if (!TextureManager::Instance()->load("sBullet.png", "bullet", TheGame::Instance()->getRenderer()))
    {
        return false;
    }

    if (!TextureManager::Instance()->load("background.png", "background", TheGame::Instance()->getRenderer()))
    {
        return false;
    }
    ...
    if (!TheTextureManager::Instance()->load("overBackground.png", "overBackground", TheGame::Instance()->getRenderer()))
    {
        return false;
    }
